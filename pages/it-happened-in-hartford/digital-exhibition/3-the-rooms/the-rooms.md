...
{% include feature/image.html objectid="GROO_Nursery_2023-01" width="75" %}</div></details>
...
{% include feature/image.html objectid="GROO_LangdonBedroom_2011-01" width="75" %} </div></details>
...
{% include feature/image.html objectid="Groo_GeorgeRoom_2011-01" width="75" %} </div></details>
...
{% include feature/image.html objectid="GROO_AristFriendsRom_2023-01" width="75" %} </div></details>
