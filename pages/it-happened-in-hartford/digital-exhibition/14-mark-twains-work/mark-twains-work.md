...
{% include feature/image.html objectid="MTHM_359-67_ID-01" width="75" %}
...
{% include feature/image.html objectid="MTHM_SLC_Alone1903-21" width="75" %}
<details open>
  ...
  <p>Mark Twain's study is now on the ground of Elmira Colleage and is cared for by the<a href="https://marktwainstudies.com/"> Center for Mark Twain Studies</a>. </p>
    ...
    {% include feature/image.html objectid="MTHM_113" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_2251-75" width="75" %}
<details open>
  ...
  <p>In 1861, a 25 year-old Samuel Clemens, having left his job as a riverboat pilot on the Mississippi River because of the outbreak of the Civil War, set out by stagecoach with his older brother, Orion, for the Nevada Territory. _Roughing It_, part autobiography, part travelog, part tall tale, is Twain’s account of the people and places he experienced when he and the American West still were young.</p>
   ...
   {% include feature/image.html objectid="MTHM_702-72" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_175" width="75" %}
<details open>
 ...
 {% include feature/image.html objectid="MTHM_359-67" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_4054-82" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_5487-2017" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_618" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_565" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_7264" width="75" %}
  {% include feature/image.html objectid="MTHM_88-64" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_163" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_158-65" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_786-72" width="75" %}
<details open>
  ...
  {% include feature/image.html objectid="MTHM_775-72" width="75" %}
<details open>
